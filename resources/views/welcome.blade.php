...
<head>
    ...
    <title>Website Undangan Pernikahan Ari dan Helma Secara Online</title>
    ...
    <meta name="title" content="Website Undangan Pernikahan Ari dan Helma Secara Online">
    <meta name="description" content="Website Undangan Pernikahan Ari dan Helma Secara Online">
    ...
    <meta property="og:title" content="Website Undangan Pernikahan Ari dan Helma Secara Online">
    <meta property="og:description" content="Website Undangan Pernikahan Ari dan Helma Secara Online">
    ...
    <meta property="og:image:alt" content="Website Undangan Pernikahan Ari dan Helma Secara Online">
    <meta property="og:type" content="website">
    <meta property="og:locale" content="id_ID">
    <meta property="og:url" content="https://ulems.my.id">
    <meta property="og:site_name" content="Website Undangan Pernikahan Ari dan Helma Secara Online">

    <!-- Appearance -->
    <meta name="mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-title" content="Website Undangan Pernikahan Ari dan Helma Secara Online">
    ...
    <main class="bg-dark text-light" data-bs-spy="scroll" data-bs-target="#navbar-menu" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
        ...
        <section class="container" id="home">
            ...
            <div class="text-center pt-4">
                ...
                <h1 class="font-esthetic my-4" style="font-size: 3rem;">Ari & Helma</h1>
                <p class="mb-0" style="font-size: 1.5rem;">Sabtu, 01 Juni 2023</p>

                <a class="btn btn-outline-light btn-sm shadow rounded-pill px-3 my-2" target="_blank" href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=The%20Wedding%20of%20Ari%20and%20Helma&details=The%20Wedding%20of%20Ari%20and%20Helma%20|%201%20Juni%202024%20|%20Kp.%20Pasar%20kemis%20RT%206%20RW%2014%20No%2034.%20Kelurahan%20Manggahang,%20Kabupaten%20Bandung%20|%2010.00%20-%2011.00%20WIB&dates=20240601T100000/20240601T100000&location=https://maps.app.goo.gl/Ly96oUMaYYwZr9t79">
            ...
            <div class="text-center">
                ...
                <div class="overflow-x-hidden">
                    ...
                    <div data-aos="fade-right" data-aos-duration="2000">
                        ...
                        <h1 class="font-esthetic" style="font-size: 3rem;">Muhamad Ari Sawali</h1>
                        <p class="mt-3 mb-0" style="font-size: 1.25rem;">Putra</p>
                        <p class="mb-0">Bapak Jajat Sudrajat & Ibu Cucu Aisyah</p>
                    </div>
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000">
                        ...
                        <h1 class="font-esthetic" style="font-size: 3rem;">Helma Adelia</h1>
                        <p class="mt-3 mb-0" style="font-size: 1.25rem;">Putri</p>
                        <p class="mb-0">Bapak Kaswadi & Ibu Reni Eka yanti</p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <div class="border rounded-pill shadow py-2 px-4 mx-2 mb-4">
                        ...
                        <div class="row justify-content-center" data-time="2024-06-01 10:00:00" id="count-down">
                            <div class="col-3 p-1">
                    ...
                    <div class="py-2" data-aos="fade-up" data-aos-duration="1500">
                        <a href="https://maps.app.goo.gl/Ly96oUMaYYwZr9t79" target="_blank" class="btn btn-outline-light btn-sm rounded-pill shadow-sm mb-2 px-3">
                            <i class="fa-solid fa-map-location-dot me-2"></i>Lihat Google Maps
                        </a>
                        <p class="mb-0 mt-1 mx-1 pb-4" style="font-size: 0.9rem;">
                            Kp. Pasar kemis RT 6 RW 14 No 34. Kelurahan Manggahang, Kabupaten Bandung.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="overflow-x-hidden">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-5 card-body border rounded-4 shadow p-3 m-3" data-aos="fade-down" data-aos-duration="1500">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/SeaBank.svg/504px-SeaBank.svg.png" class="img-fluid w-50 rounded" alt="bni">

                                <p class="card-text mt-3 mb-0" style="font-size: 0.9rem;">No. Rekening 901211769212</p>
                                <p class="card-text" style="font-size: 0.9rem;">a.n Muhamad Ari Sawali</p>

                                <!-- Ubah juga data-copy sesuai dengan no rekening -->
                                <button class="btn btn-outline-dark btn-sm rounded-3" data-copy="901211769212" onclick="util.copy(this, 'Tersalin')" autofocus>Salin No. Rekening</button>
                            </div>

                            <div class="col-5 card-body border rounded-4 shadow p-3 m-3" data-aos="fade-down" data-aos-duration="1500">
                               <img src="assets/qr-saweria.png" class="img-fluid w-50 rounded" alt="bri">

                                <p class="card-text mt-3 mb-0" style="font-size: 0.9rem;">Scan saweria untuk memberikan tanda terima kasih</p>

                                <!-- Ubah juga data-copy sesuai dengan no rekening -->
                                <a class="btn btn-outline-dark btn-sm rounded-3" href="https://saweria.co/arisawalii" target="_blank">Klik untuk menuju saweria</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="loading-page bg-black" id="welcome" style="opacity: 1;">
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
            <div class="text-center">
                ...
                <h1 class="font-esthetic my-4" style="font-size: 2.5rem;">Ari & Helma</h1>
